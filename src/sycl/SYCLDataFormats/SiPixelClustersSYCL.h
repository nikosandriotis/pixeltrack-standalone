...
public:
  ...
  public:
    // DeviceConstView() = default;
     ...
     __inline__ uint32_t moduleStart(int i) const { return *(moduleStart_ + i); }
     __inline__ uint32_t clusInModule(int i) const { return *(clusInModule_ + i); }
     __inline__ uint32_t moduleId(int i) const { return *(moduleId_ + i); }
     __inline__ uint32_t clusModuleStart(int i) const { return *(clusModuleStart_ + i); }
